  ...
  return (
    <div className={cn(spaceGrotesk.className, className)}>
      <div className="flex items-center gap-2 text-zinc-700 dark:text-white">
        <LogoIcon className={cn("size-5 text-green-500", iconClassName)} suffix="-full" />
        <div className="flex flex-col">
          ...
          <span className="-mt-1 text-[9px] font-bold text-green-500/70 uppercase tracking-wider">
            GROCERY
          </span>
        </div>
      </div>
